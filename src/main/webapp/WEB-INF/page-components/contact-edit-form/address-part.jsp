...
<div class="jlab-row">
    <div class="jlab-cell-6">
        <div class="jlab-form-item">
            ...
            <input id="edit-form-country"
                   type="text"
                   name="country"
                   value="${fullContact.country}"
        ...
        <div class="jlab-form-item">
            ...
            <input id="edit-form-town"
                   type="text"
                   name="town"
                   value="${fullContact.town}"
        ...
        <div class="jlab-form-item">
            ...
            <input id="edit-form-zip-code"
                   type="text"
                   name="zipCode"
                   value="${fullContact.zipCode}"
    ...
    <div class="jlab-cell-6">
        <div class="jlab-form-item">
            ...
            <input id="edit-form-street"
                   type="text"
                   name="street"
                   value="${fullContact.street}"
        ...
        <div class="jlab-form-item">
            ...
            <input id="edit-form-house-number"
                   type="text" name="houseNumber"
                   value="${fullContact.houseNumber}"
        ...
        <div class="jlab-form-item">
            ...
            <input id="edit-form-flat-number"
                   type="text"
                   name="flatNumber"
                   value="${fullContact.flatNumber}"
