        ...
        <div class="jlab-row">
            ...
            <div class="jlab-cell-6">
                <div class="jlab-form-item">
                    <input class="jlab-hidden"
                           name="contactId"
                           value="${fullContact.id}">
                    <label for="edit-form-first-name">${labels.get('first.name')}
                        <span class="jlab-required">*</span>
                    </label>
                    <input id="edit-form-first-name"
                           type="text"
                           name="firstName"
                           value="${fullContact.firstName}"
                           placeholder="${labels.get('first.name.placeholder')}"
                           data-validation-type="stringRequired20Chars"
                           maxlength="20"
                           required/>
                </div>

                <div class="jlab-form-item">
                    <label for="edit-form-last-name">${labels.get('last.name')}
                        <span class="jlab-required">*</span>
                    </label>
                    <input id="edit-form-last-name"
                           type="text"
                           name="lastName"
                           value="${fullContact.lastName}"
                ...
                <div class="jlab-form-item">
                    ...
                    <input id="edit-form-second-name"
                           type="text"
                           name="secondName"
                           value="${fullContact.secondName}"
            ...
            <div class="jlab-cell-6">
                <div class="jlab-form-item">
                    ...
                    <input id="edit-form-nationality"
                           type="text"
                           name="nationality"
                           value="${fullContact.nationality}"
                ...
                <div class="jlab-form-item">
                    ...
                    <input id="edit-form-web-site"
                           type="text"
                           name="webSite"
                           value="${fullContact.webSite}"
                           placeholder="${labels.get('web.site.placeholder')}"
                           maxlength="100"
                ...
                <div class="jlab-form-item">
                    ...
                    <input id="edit-form-email"
                           type="text"
                           name="eMail"
                           value="${fullContact.eMail}"
                           placeholder="${labels.get('e.mail.placeholder')}"
                           maxlength="50"
                ...
                <div class="jlab-form-item">
                    ...
                    <input id="edit-form-company"
                           type="text"
                           name="currentJob"
                           value="${fullContact.currentJob}"
                           placeholder="${labels.get('company.placeholder')}"
                           maxlength="30"
