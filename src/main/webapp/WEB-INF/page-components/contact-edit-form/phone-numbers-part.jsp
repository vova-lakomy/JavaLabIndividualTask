...
<div id="phone-number-caption"
    ...
    <div class="jlab-cell-12 jlab-inner-table-caption">
        ...
        <div class="jlab-pull-right jlab-button-block">
            <button id="button-show-phone-number-modal"
                    type="button"
                    class="jlab-button">${labels.get('add.new')}</button>
            <button id="button-delete-phone-number"
                    type="button"
...
<c:choose>
    <c:when test="${fullContact.phoneNumbers != null}">
        <div id="inner-phone-number-table"
                    ...
                    <ul class="jlab-row jlab-vertical-align-top">
                        <li class="jlab-cell-4">
                            ...
                            <textarea class="jlab-hidden"
                                      name="comment">${phoneNumber.comment}</textarea>
                            <input type="checkbox"
                                   name="selectedPhoneId"
                                   value="${phoneNumber.id}"
                                   id="phoneNumberId-${counter.index}"
                                   data-action="deletePhone">
                        ...
                        <li class="jlab-cell-2">${phoneNumber.type}</li>
                        <li class="jlab-cell-6">
                            <textarea
                                    readonly
                                    class="jlab-textarea-read-only">${phoneNumber.comment}</textarea>
    ...
    <c:otherwise>
        <div id="phone-numbers-empty-table"
             class="jlab-row jlab-vertical-padding-10">
            <div class="jlab-cell-12">
                <i>${labels.get('nothing.to.display')}
                    <a id="hrefModalPhoneAdd"
                       href="#">${labels.get('add')}</a>
                </i>
            </div>
        </div>
        <div id="inner-phone-number-table"
